...
We maintain a [contributing.md](https://github.com/DeDevsClub/devcn-ui/blob/main/.github/CONTRIBUTING.md) file in the repository that outlines the process for contributing to Devcn UI Design Registry. Please refer to it for more detailed information on the process. Remember that this registry is intended to be a minimal template that projects can build upon to create their own specialized chatbot interface components.